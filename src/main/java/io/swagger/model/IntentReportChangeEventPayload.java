...
public class IntentReportChangeEventPayload   {
  @JsonProperty("intentReport")
  private IntentReport intentReport = null;

  public IntentReportChangeEventPayload intentReport(IntentReport intentReport) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IntentReportChangeEventPayload intentReportChangeEventPayload = (IntentReportChangeEventPayload) o;
    return Objects.equals(this.intentReport, intentReportChangeEventPayload.intentReport);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntentReportChangeEventPayload {\n");
